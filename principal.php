        ...
        <div class="sidebar-fixed position-fixed">
            ...
            <div class="list-group list-group-flush" id="menu">
                <ul>
                    ...
                    <li><a   id="capacitaciones" class="list-group-item list-group-item-action waves-effect">
                        <i class="fa fa-table mr-3"></i>Capacitaciones</a></li>
                    <li><a href="#" id="preguntas" class="list-group-item list-group-item-action waves-effect">
